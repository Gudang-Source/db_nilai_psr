...
<div class="content">
  <div class="content-font">
    <center>
      MENU LOGIN : <button onclick="show_login_admin()">LOGIN ADMIN</button> -- <button onclick="show_login_guru()">LOGIN GURU</button>
      <hr>
      ...
      <div id="login_admin" style="display: block;">
        <form action="action/login.php" method="post">
              <table>
                ...
                <tr>
                  <td><button type="submit" name="login_admin">LOGIN</button></td>
                  <td><button type="reset" name="submit">RESET</button></td>
                </tr>
              </table>
          </form>
      </div>
      ...
      <div id="login_guru" style="display: none;">
        <form action="action/login.php" method="post">
            <table>
              ...
              <tr>
                <td><button type="submit" name="login_guru">LOGIN</button></td>
                <td><button type="reset" name="submit">RESET</button></td>
              </tr>
            </table>
      </form>
