...
--
-- Host: 127.0.0.1
-- Generation Time: 27 Feb 2019 pada 13.06
...
(1, 'admin', 'admin', 'Purwa', 'Sabrang', '08123456', 'psr@gmail.com');
...
--
ALTER TABLE `mengajar`
  MODIFY `id_mengajar` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `siswa`
  MODIFY `nis` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
